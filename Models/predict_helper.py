...
MODEL_PATH = 'Models/artifacts/model_data.joblib'
...
def prepare_input(age, income, loan_amount, loan_tenure_months, avg_dpd_per_deliquence,
                    deliquent_ratio, credit_utilization_ratio, num_open_accounts, residence_type,
    ...
    input_data = {
        ...
        'avg_dpd_per_deliquence': avg_dpd_per_deliquence,
...
def predict(age, income, loan_amount, loan_tenure_months, avg_dpd_per_deliquence,
            deliquent_ratio, credit_utilization_ratio, num_open_accounts,
            residence_type, loan_purpose, loan_type):
    # Prepare input data
    input_df = prepare_input(age, income, loan_amount, loan_tenure_months, avg_dpd_per_deliquence,
                             deliquent_ratio, credit_utilization_ratio, num_open_accounts, residence_type,
                             loan_purpose, loan_type)
