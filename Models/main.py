...
st.title("Hamro Finanace : Credit Ris Modeling")
...
with row2[2]:
    avg_dpd_per_deliquence = st.number_input('Avg DPD', min_value=0, value=20)
...
if st.button('Calculate Risk'):
    ...
    probability, credit_score, rating = predict(age, income, loan_amount, loan_tenure_months, avg_dpd_per_deliquence,
